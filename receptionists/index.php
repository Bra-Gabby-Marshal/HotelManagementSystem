...
<head>
  <meta charset="UTF-8">
  <title>INVISIBLE HOTEL RECEPTIONIST</title>
...
<body>
 ...
 <div class="container">
    ...
    <div class="bottom">  <h3><a href="../index.php">Visit Home Page</a></h3></div>
...
<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $sql = "SELECT id FROM receptionist_login WHERE usname = '$myusername' and pass = '$mypassword'";
