...
<body>
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="settings.php"><i class="fa fa-dashboard"></i>User Dashboard</a>
                    </li>
					<li>
                        <a href="usersetting.php"><i class="fa fa-dashboard"></i>Administrators</a>
                    </li>
					<li>
                        <a  class="active-menu" href="receptionist.php"><i class="fa fa-dashboard"></i>Receptionist</a>
                    </li>
        ...
        <div id="page-wrapper" >
			 ...
			 <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                           RECEPTIONIST<small> accounts </small>
                        </h1>
                    </div>
                </div> 
            ...
            <?php
						include ('db.php');
						$sql = "SELECT * FROM `receptionist_login`";
            ...
            <div class="row">
                <div class="col-md-12">
										...
										while($row = mysqli_fetch_array($re))
										{
											...
											if($id % 2 ==0 )
											{
												echo"<tr class='gradeC'>
													...
													<td><a href=receptionistdel.php?eid=".$id ." <button class='btn btn-danger'> <i class='fa fa-edit' ></i> Delete</button></td>
												</tr>";
											}
											else
											{
					...
					<div class="panel-body">
						...
						if(isset($_POST['in']))
						{
							...
							$newsql ="Insert into receptionist_login (usname,pass) values ('$newus','$newps')";
				...
				if(isset($_POST['up']))
				{
					...
					$upsql = "UPDATE `receptionist_login` SET `usname`='$usname',`pass`='$passwr' WHERE id = '$id'";
