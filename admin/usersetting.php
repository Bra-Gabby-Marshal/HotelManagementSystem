        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
					...
					<li>
                        <a class="active-menu" href="usersetting.php"><i class="fa fa-dashboard"></i>Administrators</a>
                    </li>
					<li>
                        <a  href="receptionist.php"><i class="fa fa-dashboard"></i>View Receptionist</a>
                    </li>
